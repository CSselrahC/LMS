...
public class Admin extends User {
	...
	public void createUser(String userType) {
		...
		if(userType.equals("Student")) {
			Student student = new Student(id, lastName, firstName, password);
			accountManager.addStudentAccount(student);
		}
		
		if(userType.equals("Instructor")) {
			Instructor instructor = new Instructor(id, lastName, firstName, password);
	...
	public void changePasswordOf(User user) {
		String password = "";
